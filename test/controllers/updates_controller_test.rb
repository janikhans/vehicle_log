...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { comment: @update.comment, date: @update.date, mileage: @update.mileage, vehicle_id: @update.vehicle_id }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { comment: @update.comment, date: @update.date, mileage: @update.mileage, vehicle_id: @update.vehicle_id }
    assert_redirected_to update_path(assigns(:update))
  end
